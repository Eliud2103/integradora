            ...
            <div class="col-md-8">
                <div class="seat-container">
                    <div class="seat-map">
                        ...
                        for ($fila = 0; $fila < 2; $fila++) {
                            ...
                            for ($col = 0; $col < 10; $col++) {
                                ...
                                $src = ($class == 'occupied') ? 'assets/images/ocupado.png' : (($class == 'paid') ? 'assets/images/paid.png' : 'assets/images/disponible.png');
                    ...
                    <div class="row text-center mt-2">
                        ...
                        <div class="col-12 col-md-3 d-flex flex-column align-items-center justify-content-center">
                            <img class="opcion" src="assets/images/paid.png" alt="Pagado">
                            <p>Pagado</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelector('.seat-map').addEventListener('click', function(event) {
            ...
            if (seat && img) {
                ...
                img.src = isSelected ? 'assets/images/seleccionado.png' : seat.classList.contains('paid') ? 'assets/images/paid.png' : seat.classList.contains('occupied') ? 'assets/images/ocupado.png' : 'assets/images/disponible.png';
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        selectedSeats.forEach(index => {
                            ...
                            seat.querySelector('img').src = 'assets/images/paid.png';
                        });
                        selectedSeats = [];
                    } else {
